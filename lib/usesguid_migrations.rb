...
require 'lfe/usesguid/migrations/active_record/connection_adapters/abstract_adapter'
...
ActiveRecord::ConnectionAdapters::AbstractAdapter.send( :include, Lfe::Usesguid::Migrations::ActiveRecord::ConnectionAdapters::AbstractAdapter ) if defined?( ActiveRecord::ConnectionAdapters::AbstractAdapter )
