...
This will create a field named account_id that is of the correct type for usesguid.  However, if you would like 
for it to not be nullable you must include the :null => false option:

  t.references_with_guid :account, :null => false
...
From the plugins directory of your Rails project:

  git clone git://github.com/midas/usesguid_migrations.git

or an easier route:

  script/plugin install git://github.com/midas/usesguid_migrations.git
